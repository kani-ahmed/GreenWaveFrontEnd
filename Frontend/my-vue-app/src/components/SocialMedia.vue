<template>
        ...
        <main>
            <div class="button-class">
                <div class="button-group-top">
                    ...
                    <button class="square-button" @click="createPost">Create Post</button>
                    <button class="square-button" @click="sendMessage">Send Message</button>
                </div>
    ...
    <div v-if="showPostModal" class="modal">
        <div class="modal-content">
            ...
            <form id = "post-form">
                <textarea v-model="postContent" placeholder="Write your post here">
                 </textarea>
            </form>
